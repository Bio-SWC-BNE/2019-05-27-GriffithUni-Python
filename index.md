...
venue: "Introduction to Python - Software Carpentry<br>N53 0.63 Nathan Campus, Griffith University"        # brief name of host site without address (e.g., "Euphoric State University")
...
humandate: "27th-29th May"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: [Kim Keogh, Ido Bar, Amanda Miotto] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
  ...
  <div>
    ...
    <div class="tab-content">
      <article role="tabpanel" class="tab-pane active" id="shell-windows">
        ...
        <ol>
          <li>Download the Git for Windows <a href="https://git-for-windows.github.io/">
er</a>.</li>
